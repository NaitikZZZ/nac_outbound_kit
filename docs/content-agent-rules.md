...
Style, format, and copy rules the agent applies when drafting outbound content for this kit.
...
- **Variant B** - long-form, pulled from the matching sequence in `templates/email-sequences/`.
